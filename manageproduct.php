        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse"
                    ...
                    <i class="bi bi-menu-button-wide"></i><span>Manage Products</span><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-lg table-striped">
                                  ...
                                  data-id="<?php echo $row['User_id']; ?>">View</button></td>
                      <td><button class="<?php echo ($row['Status'] == 1) ? 'disable-btn btn btn-danger' : 'disable-btn btn btn-success'; ?>"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.view-btn').on('click', function () {
                ...
                // redirect to the view page passing the user id as parameter
