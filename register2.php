...
<body>
                ...
                <div class="card-body">
                    ...
                    <form class="form-inline" method="POST" action="" enctype="multipart/form-data">
                        <div class="input-group">
                            <input class="input--style-2" id="name" type="text" placeholder="Full Name" name="name"
                                required>
                        </div>
                        <p id="name_error"></p>
                        <div class="input-group">
                            <input class="input--style-2" id="email" type="email" placeholder="Email" spellcheck="false"
                                name="email" required>
                        </div>
                        <p id="email_error"></p>
                        <div class="input-group mb">
                            <input class="input--style-2" id="username" type="text" placeholder="Username"
                                spellcheck="false" name="username" required>
                        </div>
                        <p id="uname_error"></p>
                        <div class="input-group">
                            <input class="input--style-2" id="passwd" type="password" placeholder="Password"
                                name="password" required>
                        </div>
                        <p id="passwd_error"></p>
                        <div class="input-group">
                            <input class="input--style-2" id="cpasswd" type="password" placeholder="Confirm Password"
                                name="cpword" required>
                        </div>
                        <p id="cpasswd_error"></p>
                        <div class="input-group">
                            <input class="input--style-2" id="phone" type="text" placeholder="Phone number" name="phone"
                                required>
                        </div>
                        <p id="phone_error"></p>
                        <div class="input-group">
                            <input class="input--style-2" id="house" type="text" placeholder="House Name"
                                spellcheck="false" name="house" required>
                        </div>
                        <p id="house_error"></p>
                        <div class="input-group">
                            <input class="input--style-2" id="city" type="text" placeholder="City Name"
                                spellcheck="false" name="city" required>
                        </div>
                        <p id="city_error"></p>
                        <div class="input-group">
                            <input class="input--style-2" id="zip" type="text" placeholder="Zip Code" name="zip"
                                required>
                        </div>
                        <p id="zip_error"></p>
                        <div class="form-group">
                            <p class="input--style-2">Profile Picture</p><input class="file" type="file" id="file"
                                name="file" onchange="show(this)" accept="image/png,image/gif,image/jpeg" required />
                        </div>
                        <p id="image_error"></p>
                        <div class="p-t-30">
                            <!-- <button class="btn btn--radius btn--green" type="submit" name="submit" Onclick="index.php">Register</button> -->
                            <input class="btn btn--radius btn--green" id="btn" type="submit" disabled name="submit"
                                value="Register">
                        </div>
                        <p id="login_error"></p>
                    </form>
                    <a href="login.php" class="link" style="text-decoration:none;margin-left:150px;">Already
                        registered?Sign
                        in</a>
                </div>
            </div>
    ...
    if (isset($_POST["submit"])) {
        ...
        // $to_email = $em;
        // $command = escapeshellcmd('email_verification.py ' . $to_email . ' ' . $verification_code);
        // shell_exec($command);
        $us = $_POST["username"];
        $ps = $_POST["password"];
        $ph = $_POST["phone"];
        ...
        if ($us != null && $ps != null && $na != null && $em != null) {
            ...
            if (mysqli_num_rows($res) > 0) {
                ...
                $q = "SELECT User_id FROM register_tbl ORDER BY User_id DESC LIMIT 1";
                $res = mysqli_query($con, $q);
                $r = mysqli_fetch_array($res);
                $userid = $r['User_id'];
                $query = "insert into login_tbl(User_id,Username,Password) values('$userid','$us','$ps')";
