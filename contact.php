      ...
      <div class="row">
        <div class="col-lg-10 offset-lg-1">
          <div class="cta-content">
            ...
            <p>We will always be ready to help you</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row text-center">
        ...
        <div class="col-md-4">
          ...
          <h5><a href="https://mail.google.com/mail/">thecornerstore@gmail.com</a></h5>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>
            Copyright © 2022 The Corner Store
          </p>
        </div>
      </div>
    </div>
