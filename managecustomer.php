...
<body>
    ...
    <main id="main" class="main">
        ...
        <?php
        $query = "SELECT * FROM `register_tbl` where Role like 0";
                    ...
                    <div class="modal-body">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="houseInput" readonly>
                            </div>
                            <div class="form-group">
                                <label for="cityInput">City Name:</label>
                                <input type="text" class="form-control" id="cityInput" readonly>
                            </div>
                            <div class="form-group">
                                <label for="zipInput">Zip Code:</label>
                                <input type="text" class="form-control" id="zipInput" readonly>
                            </div>
                        </form>
                    </div>
                </div>
